 ...
 */
class mandarinbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "mandarin@mandarin";
    public $boxlabel;
    public $depends = array("mandarin");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/mandarin/class/mandarin.class.php";
